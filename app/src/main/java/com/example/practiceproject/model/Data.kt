...
//List top rate
class TopRate(private var poster_path: String?, private var title: String?){
    init {
        this.poster_path = poster_path
        this.title = title
    }
...
class NowPlaying(private var poster_path: String?, private var title: String?){
    init {
        this.poster_path = poster_path
        this.title = title
    }
...
//list upcoming
class Upcoming(private var poster_path: String?, private var title: String?){
    init {
        this.poster_path = poster_path
        this.title = title
    }
